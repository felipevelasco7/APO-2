...
public class ControllerTest extends TestCase {
    ...
    public void testDeleteProduct2() throws Exception{
        setupStage2();
        try {
            controller.deleteProduct("silla");
    ...
    public void testIncreaseQuantity(){
        setupStage2();
        controller.IncreaseQuantity("cuaderno",2);
        assertEquals(5, controller.products.get(0).getQuantity());
    }
    ...
    public void testRegisterProduct2(){
        setupStage2();
        controller.registerProducts("camiseta", "talla m", 15, 5, 3);//3=ropa
        assertEquals("camiseta", controller.products.get(3).getProductName());
    ...
    public void testRegisterOrder() {
        setupStage2();
        try {
            controller.registerOrder("Carlos", "cuaderno,megafono", "21/2/2023");
        } catch (Exception e) {
            System.out.println("Este producto no esta registrado");
        }
