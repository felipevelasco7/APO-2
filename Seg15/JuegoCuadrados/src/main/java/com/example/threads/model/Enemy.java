...
public class Enemy{
    ...
    public boolean isReadyToErease() {
        return readyToErease;
    }

    public void setReadyToErease(boolean readyToErease) {
        this.readyToErease = readyToErease;
    }
}
